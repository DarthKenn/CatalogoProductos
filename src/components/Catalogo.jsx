...
const Catalogo = () => {
  ...
  } else if (ordenCampo === 'marca') {
    productosOrdenados.sort((a, b) =>
      ordenAscendente ? a.marca.localeCompare(b.marca) : b.marca.localeCompare(a.marca)
    );
    ...
    <div className="container">
      ...
      <div className="mb-3 d-flex justify-content-between align-items-center">
        ...
        <div className="btn-group">
          ...
          <button className={`btn btn-outline-primary ${ordenCampo === 'marca' ? 'active' : ''}`} onClick={() => ordenarProductos('marca')}>
            Marca {ordenCampo === 'marca' && (ordenAscendente ? '▲' : '▼')}
          </button>
